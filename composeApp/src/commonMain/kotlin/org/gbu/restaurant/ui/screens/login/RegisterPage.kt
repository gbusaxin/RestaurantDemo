...
import restaurantdemo.composeapp.generated.resources.already_have_account
...
import restaurantdemo.composeapp.generated.resources.name
import restaurantdemo.composeapp.generated.resources.or_sign_up_with
        ...
        Box(Modifier.fillMaxSize().padding(16.dp)) {
            Column(
                ...
                Column(horizontalAlignment = Alignment.Start) {
                    ...
                    Spacer(Modifier.height(4.dp))
                    PasswordTextField(
                        isError = isPasswordError, // TODO this attributy commented
                        value = state.passwordLogin,
                        onValueChange = {
                            events(LoginEvent.OnUpdatePasswordLogin(it))
                            isPasswordError = it.length < 8 // TODO add correct password validation
                        },
                        modifier = Modifier.fillMaxWidth()
                    )
